...
const Card=()=>{
    // console.log(data);
    return (
        <Container className='rounded-4 mt-4 text-center bg-warning'>
            <Image className='mt-3' style={{width:"400px"}} src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Flag_of_the_Romani_people.svg/800px-Flag_of_the_Romani_people.svg.png" alt="roman"/>
            <h1>Kim Bunlar?</h1>
